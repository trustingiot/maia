...
async function testGateway() {
	...
	console.log("#### Generate with random seed ####")
	// Generate
	address = MAIA.MAIA.keyGen()
	request = {
		method: MAIA.MAIA_METHOD.GENERATE,
		address: address
	}
	...
	// Obtain
	request = {
		method: MAIA.MAIA_METHOD.OBTAIN,
		maia: response.maia
	}
	...
	address = MAIA.MAIA.keyGen()
	request = {
		method: MAIA.MAIA_METHOD.UPDATE,
		address: address,
		seed: seed,
		maia: maia
	}
